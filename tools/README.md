...
Rust言語の環境構築が面倒な方向けに、[Windows用のコンパイル済みバイナリ](https://img.atcoder.jp/awtf2025heuristic/sJKH3KO4_windows.zip)も用意してあります。
...
- `--K=50` 生成される入力の $K$ の値を指定されたものに固定
- `--W=2` 生成される入力の $W$ の値を指定されたものに固定
...
より機能が豊富な[ウェブ版のビジュアライザ](https://img.atcoder.jp/awtf2025heuristic/sJKH3KO4.html?lang=ja)も利用可能です。
